...
*an object* is liked by *a person*.

the knowledge base sample includes:
michael scott eats crabs if
    it is not the case that
    michael scott eats crabs.

jim halpert eats jackfruit if
    pam beasely eats jackfruit
    or dwight schrute eats fruit
    and fruit is liked by angela.

stanley doesnt like the state of america.
`
